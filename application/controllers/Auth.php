...
class Auth extends CI_Controller {
	...
	public function register()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			$this->session->set_flashdata('message', '<div class="alert alert-success alert">Pendaftaran Berhasil, silahkan login untuk mulai booking Kost.</div>');
			redirect(base_url());
		}
			else
			{
			...
			else
			{
				...
				if ($this->ion_auth->login_front($this->input->post('identity'), $this->input->post('password'), $remember))
				{
					...
					else
					{
						...
						$this->session->set_flashdata('message','<div class="alert alert-block alert-danger"><i class="ace-icon fa fa-bullhorn green"></i>Email atau Password salah, mohon diperiksa lagi</div>', $this->ion_auth->errors(''));
