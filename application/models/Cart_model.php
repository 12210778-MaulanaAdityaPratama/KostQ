...
class Cart_model extends CI_Model
{
  ...
  function get_cart_per_customer_finished_back($id)
  {
    ...
    transaksi_detail.trans_id, transaksi_detail.kost_id, transaksi_detail.tanggal, transaksi_detail.jam_mulai, transaksi_detail.durasi, transaksi_detail.jam_selesai, transaksi_detail.harga_jual, transaksi_detail.total,
    provinsi.nama_provinsi,kota.nama_kota,
    users.id, users.name, users.address
    ');
    $this->db->join('kost', 'transaksi_detail.kost_id = kost.id_kost');
  ...
  function get_by_id_front1($id3)
  {
    $this->db->where('nama_kost', $id3);
