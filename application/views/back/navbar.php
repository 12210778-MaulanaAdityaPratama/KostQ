<header class="main-header">
  <a href="<?php echo base_url('admin/dashboard') ?>" class="logo bg-blue">
    <span class="logo-lg"><b>KostQ</b></span>
  </a>
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-body">
              ...
              <div class="col-xs-6 text-center">
                <a href='<?php echo base_url() ?>admin/auth/logout' class='btn btn-default btn-flat'>Keluar</a>
              </div>
            </li>
          </ul>
        </li>
