					...
					<div class="box box-primary">
						<div class="box-body">
							...
							<div class="form-group"><label>Nama <?php echo $module ?></label>
								<?php echo form_input($nama_promosi, $promosi->nama_promosi); ?>
							</div>
							<div class="form-group"><label>Harga</label>
								<?php echo form_input($harga, $promosi->harga); ?>
							</div>
							<div class="form-group"><label>Link kost</label>
								<?php echo form_input($link, $promosi->link); ?>
							</div>
							<div class="form-group"><label>Deskripsi</label>
								<?php echo form_textarea($deskripsi, $promosi->deskripsi); ?>
							</div>
							<div class="form-group"><label>Nama Kategori</label>
								<?php echo form_dropdown('', $ambil_kategori, $promosi->kategori, $kat_id); ?>
							</div>
							<div class="form-group"><label>Foto Sebelumnya</label><br>
								<img src="<?php echo base_url('assets/images/promosi/' . $promosi->foto . $promosi->foto_type . '') ?>"
									width="200px" />
							</div>
							...
							<?php echo form_input($id_promosi, $promosi->id_promosi); ?>
