                    ...
                    <tbody>
                      <?php $no=1; foreach($get_all as $data){ ?>
                        <tr>
                          ...
                          <td style="text-align: center"><?php echo $data->nama_promosi ?></td>
                          ...
                          <td style="text-align: center">
                            <?php
                            echo anchor(site_url('admin/promosi/update/'.$data->id_promosi),'<i class="fa fa-pencil"></i>','title="Edit", class="btn btn-sm btn-warning"'); echo ' ';
                            echo anchor(site_url('admin/promosi/delete/'.$data->id_promosi),'<i class="fa fa-remove"></i>','title="Hapus", class="btn btn-sm btn-danger", onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"');
                            ?>
                          </td>
                        </tr>
                      <?php } ?>
