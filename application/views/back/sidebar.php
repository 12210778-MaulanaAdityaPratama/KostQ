<aside class="main-sidebar">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                <?php if($this->uri->segment(2)=="transaksi" && $this->uri->segment(3)!="update_diskon"){echo "class='active'";} ?>>
                <a href="<?php echo base_url('admin/transaksi') ?>">
                    <i class="fa fa-book"></i> <span>Transaksi</span>
                </a>
            </li>
            <li <?php if($this->uri->segment(2) == "kost"){echo "class='active'";} ?>>
                <a href='#'><i class="fa-solid fa-house"> </i><span> Kost </span><i
                        class='fa fa-angle-left pull-right'></i></a>
                <ul class='treeview-menu'>
                    <li
                        <?php if($this->uri->segment(2) == "kost" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>>
                        <a href='<?php echo base_url('admin/kost/create') ?>'><i class="fa-solid fa-house"></i> Tambah
                            Kost </a>
                    </li>
                    <li
                        <?php if($this->uri->segment(2) == "kost" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
            ...
            <php endif ?> -->
            <?php if ($this->ion_auth->is_AdminKost()): ?>
            <li <?php if($this->uri->segment(2) == "promosi"){echo "class='active'";} ?>>
                <a href='#'><i class='fa fa-newspaper-o'></i><span> promosi </span><i
                        class='fa fa-angle-left pull-right'></i></a>
                <ul class='treeview-menu'>
                    <li
                        <?php if($this->uri->segment(2) == "promosi" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>>
                        <a href='<?php echo base_url('admin/promosi/create') ?>'><i class='fa fa-circle-o'></i> Tambah
                            promosi </a>
                    </li>
                    <li
                        <?php if($this->uri->segment(2) == "promosi" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
                        <a href='<?php echo base_url('admin/promosi') ?>'><i class='fa fa-circle-o'></i> Data promosi </a>
                    </li>
                </ul>
            </li>
            <?php endif ?>
            <li <?php if($this->uri->segment(2) == "kategori"){echo "class='active'";} ?>>
                ...
                <ul class='treeview-menu'>
                    <li
                        <?php if($this->uri->segment(2) == "kategori" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>>
                        <a href='<?php echo base_url('admin/kategori/create') ?>'><i class='fa fa-circle-o'></i> Tambah
                            Kategori </a>
                    </li>
                    <li
                        <?php if($this->uri->segment(2) == "kategori" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
            ...
            <li <?php if($this->uri->segment(2) == "slider"){echo "class='active'";} ?>>
                ...
                <ul class='treeview-menu'>
                    <li
                        <?php if($this->uri->segment(2) == "slider" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>>
                        <a href='<?php echo base_url('admin/slider/create') ?>'><i class='fa fa-circle-o'></i> Tambah
                            Slider </a>
                    </li>
                    <li
                        <?php if($this->uri->segment(2) == "slider" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
            ...
            <li <?php if($this->uri->segment(2) == "kontak"){echo "class='active'";} ?>>
                ...
                <ul class='treeview-menu'>
                    <li
                        <?php if($this->uri->segment(2) == "kontak" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>>
                        <a href='<?php echo base_url('admin/kontak/create') ?>'><i class='fa fa-circle-o'></i> Tambah
                            Kontak </a>
                    </li>
                    <li
                        <?php if($this->uri->segment(2) == "kontak" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
            ...
            <?php if ($this->ion_auth->is_AdminKost()): ?>
            <li <?php if($this->uri->segment(3) == "update_diskon"){echo "class='active'";} ?>><a
                    href='<?php echo base_url() ?>admin/transaksi/update_diskon/1'> <i class="fa fa-scissors"></i>
                    <span>Diskon Member</span> </a> </li>
                    <?php endif ?>
            <?php if ($this->ion_auth->is_AdminKost()): ?>
            <li <?php if($this->uri->segment(2) == "company"){echo "class='active'";} ?>><a
            ...
            <li <?php if($this->uri->segment(3) == "edit_user"){echo "class='active'";} ?>>
                <a
                    href='<?php $user_id = $this->session->userdata('user_id'); echo base_url('admin/auth/edit_user/'.$user_id.'') ?>'>
            ...
            <li <?php if($this->uri->segment(2) == "auth" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
                ...
                <ul class='treeview-menu'>
                    <li
                        <?php if($this->uri->segment(2) == "auth" && $this->uri->segment(3) == "create_user"){echo "class='active'";} ?>>
                        <a href='<?php echo base_url() ?>admin/auth/create_user'><i class='fa fa-circle-o'></i> Tambah
                            User</a>
                    </li>
                    <li
                        <?php if($this->uri->segment(2) == "auth" && $this->uri->segment(3) == ""){echo "class='active'";} ?>>
