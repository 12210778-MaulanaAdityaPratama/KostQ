		...
		<div class="col-lg-12">
			...
			<form action="<?php echo base_url('cart/checkout') ?>" method="post">
						...
						<div class="box-body table-responsive padding">
							<?php foreach ($cart_data as $detail ) { ?>
								...
								<div class="col-sm-4">
									...
									<b><i class="fa-solid fa-phone"></i>&ensp; No. HP&ensp; : +<?php echo $detail->no_hp?></b><br>
									<b><i class="fa-solid fa-location-dot"></i>&ensp;&ensp; Lokasi&ensp; : <?php echo $detail->lokasi?></b><br>
									<hr>
									<b><i class="fa-solid fa-keyboard"></i></i>&ensp; Deskripsi : <br><br><?php echo $detail->deskripsi?></b>
									</div>
									<div class="col-sm-3"><b><i class="fa-solid fa-building"></i>&ensp; <?php echo $detail->nama_perusahaan?></b></div>
								</div>
								<hr>
								<?php }?>
								<br>
							<table id="datatable" class="table table-striped table-bordered">
								...
								<tbody>
									...
									foreach ($cart_data as $cart) { ?>
										<tr>
											<td style="text-align:left"><?php echo $cart->nama_kost ?></td>
											...
											<td style="text-align:center">
												...
												<input type="hidden" name="kost[]" value="<?php echo $cart->kost_id ?>">
												<input type="hidden" name="id_transdet[]"
													value="<?php echo $cart->id_transdet ?>">
												<input type="hidden" value="<?php echo $cart->kost_id; ?>" class="kost_id">
											</td>
											<td style="text-align:center">
				...
				<?php if (!empty($customer_data->id_trans)) { ?>
					<div class="row">
						<div class="col-lg-12">
							<?php if (!empty($cek_keranjang->kost_id)) { ?>
		...
		<script type="text/javascript">
			...
			$(function () {
				...
				$('.tanggal').on('changeDate', function (ev) {
					...
					kost_id_el = tanggal_el.parent().parent().find(".kost_id");
