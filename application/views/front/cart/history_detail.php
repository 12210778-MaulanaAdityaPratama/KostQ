						...
						<table id="datatable" class="table table-striped table-bordered">
							<thead>
								<tr>
									...
									<th style="text-align: center">Kost</th>
							...
							<tbody>
								...
								foreach ($history_detail as $history) { ?>
									<tr>
										...
										<td style="text-align:left"><?php echo $history->nama_kost ?></a></td>
										<td style="text-align:center"><?php echo $history->harga_jual ?></td>
										<td style="text-align:center"><?php echo tgl_indo($history->tanggal) ?></td>
										<td style="text-align:center"><?php echo $history->durasi ?>/Bulan</td>
										<td style="text-align:center">Rp. <?php echo number_format($history->total) ?></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
			...
			<div class="col-lg-12">
				...
				<ul>
					<li>Segera lakukan pembayaran sebelum:
						<b><?php $time = strtotime($history_detail_row->deadline);
						echo date("d F Y | H:i:s", $time); ?>
							WIB</b>, apabila melewati batas waktu tersebut maka booking dianggap batal.</li>
					<li>Jumlah yang harus Anda bayarkan adalah sebesar: Rp
						<b><?php echo number_format($history_detail_row->grand_total) ?></b></li>
					<li>Silahkan melakukan konfirmasi pembayaran ke halaman berikut ini, <a
							href="<?php echo base_url('contact') ?>">klik disini</a> atau langsung menghubungi kami ke
						customer service yang telah disediakan dan melampirkan foto bukti bayarnya.</li>
